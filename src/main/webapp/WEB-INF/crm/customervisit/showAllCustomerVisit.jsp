...
<table id="mytable" width="80%" border="3px solid orange">
    <shiro:hasPermission name="cv:insert">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">客户拜访修改</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="cvID" class="col-xs-2 control-label">客户拜访id</label>
                        <div class="col-xs-10">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel1">客户拜访新增</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
...
<script>
    $(function(){
        <shiro:hasPermission name="cv:customervisit/select">
        let t = new Mytable();
        t.init();
        </shiro:hasPermission>
        <shiro:hasPermission name="cv:customervisit/select3">
        let t2 = new Mytable2();
        t2.init();
        </shiro:hasPermission>
    })
    ...
    var Mytable = function () {
        ...
        mytable.init = function () {
            $("#mytable").bootstrapTable({
                ...
                <shiro:hasPermission name="cv:update">
                ,{
                    field: 'id',
                    title: '操作',
    ...
    function editAndDel(id, row, index) {
        return `
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <shiro:hasPermission name="cv:delete">
